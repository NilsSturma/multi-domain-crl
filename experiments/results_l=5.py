...
avg_number_shared4, too_many_shared_rate4, mixing_error_rate4, graph_error_median4 = get_statistics(info3)

# ===== PLOT =====
plot(nsamples_list, avg_number_shared2, avg_number_shared3, avg_number_shared4,
                ylabel="Average of $\hat{\ell}$",
                path=f"results-paper/avg-shared-nodes_l={l}_d={d}.png", ylim=(-0.1,3.1))
